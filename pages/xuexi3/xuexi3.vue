	    ...
	    <view class="flex-col">
	      ...
	      <view class="flex-col list space-y-16">
	        <view class="flex-col justify-start items-start list-item" >
	          <view class="group_4">
	            <text class="font_3">{{detail.title21}}</text>
	            <text class="font_2">{{detail.content21}}</text>
	          </view>
	        </view>
			
			<view class="flex-col justify-start items-start list-item" >
			  <view class="group_4">
			    <text class="font_3">{{detail.title22}}</text>
			    <text class="font_2">{{detail.content22}}</text>
			  </view>
			</view>
			
			<view class="flex-col justify-start items-start list-item" >
			  <view class="group_4">
			    <text class="font_3">{{detail.title23}}</text>
			    <text class="font_2">{{detail.content23}}</text>
			  </view>
			</view>
