...
<!--    <text class="self-start font_1 text">我的报告</text> -->
    <view class="flex-col section">
      <view class="flex-col group space-y-12">
        ...
        <text class="self-start font_2 text_6">得分：39分</text>
      </view>
      <text class="self-start font_3 text_7">(正常14分，轻度29分，中度43分，重度57分)</text>
      <view class="flex-col group_3">
        ...
        <view class="flex-col list space-y-16">
          <view class="flex-col section_3" :key="i" v-for="(item, i) in list_u2h0dqFG">
            ...
            <view class="flex-col group_4 space-y-4">
              <text class="self-end font_3" >这个分数指出你的生活中的兴奋与压力量也许是轻度的。偶尔会有一段时间压力太多，但你也许有能力去享受压力，并且很快地回到平静状态，因此你面临的压力对你健康并不会造成威胁。不过做一些松弛的练习仍是有益的。\n允许自己感受压力，并接受这些情绪的存在。认识到压力是正常的生活反应，而不是失败或弱点。如果您觉得无法应对轻度压力或需要更深入的指导，可以寻求专业的心理健康支持。心理咨询师或心理治疗师可以提供个性化的支持和帮助。</text>
            </view>
          </view>
        </view>
		...
		<view class="flex-col list space-y-16">
		  <view class="flex-col section_3 section_4" >
		    ...
		    <view class="flex-col group_4 space-y-4">
		      <text class="self-end font_3">心理压力是指个体在面对各种内外环境压力时所产生的心理反应。它可以是来自工作、学业、人际关系、家庭等方面的压力，也可以是由于个人内部的情绪、焦虑、自我要求等因素导致的压力。\n心理压力对个体的影响是多方面的，包括身体、情绪和认知等方面。长期的心理压力可能会导致焦虑、抑郁、睡眠问题、消化问题、免疫系统功能下降等身体和心理健康问题。如果您感到长期或严重的心理压力，请寻求专业的帮助。</text>
		    </view>
