	    ...
	    <view class="flex-col space-y-15">
	      <view class="flex-col section_2">
	        <view class="flex-col items-center space-y-6">
	          <text class="text_2">PSS心理压力量表</text>
	          <text class="text_3">Perceived Stress Scale</text>
	        </view>
...
<script>
  export default {
    ...
    methods: {
		...
		getData(){
			uni.request({
				url:"https://fc-mp-836eb6c6-0a4f-47c9-8149-6d32fa5245cd.next.bspapp.com/PSS_get_All",
				success:res=>{
					console.log(res);
		...
		submit() {
		  ...
		  uni.redirectTo({
		  	url:"/pages/ceshibaogao2/ceshibaogao2?score=" + this.score
		  })
		},
