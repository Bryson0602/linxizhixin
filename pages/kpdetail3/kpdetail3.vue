<template>
	<view class="detail" >		
		<view v-if="loadState">			
			...
			<view class="content">
				<view class="kp"> 技术科普</view>
				<text>{{detail.content1}}</text>
				<image src="../../static/kpnlp4.png" mode="widthFix"></image>
				<text>{{detail.content2}}</text>
				<image src="../../static/kpnlp5.png" mode="widthFix"></image>
				<view class="kp1"> 技术应用</view>
				<text>{{detail.content3}}</text>
				<image src="../../static/kpnlp2.jpg" mode="widthFix"></image>
			...
			<view class="pp">
				<image src="../../static/kpnlp3.jpg" class="image"></image>
			</view>
