<template>
	<view class="flex-col page space-y-22">
	  ...
	  <view class="flex-col space-y-10">
	    ...
	    <text class="self-start font_2 text_6">就诊科室：精神心理，心理咨询科</text>
	    <view class="flex-col">
	      <view class="flex-col items-start section_2 space-y-4">
	        <text class="font_2">概述</text>
	        <text class="font_2">·抑郁障碍的一种典型情况</text>
	        <text class="font_2">·核心症状是显著持久的情绪低落、兴趣减退等</text>
	        <text class="font_2">·最常见的精神障碍，临床治愈率高</text>
	        <text class="font_2">·自杀是抑郁症患者最严重的后果之一</text>
	      </view>
	      <view class="flex-col list space-y-16">
	        <view class="flex-col justify-start items-start list-item" :key="i" v-for="(item, i) in list_3pTJhiqY">
	          <view class="group_4">
	            <text class="font_3">疾病定义：</text>
	            <text class="font_2">抑郁症是抑郁障碍的一种典型情况...抑郁症是抑郁障碍的一种典型情况...抑郁症是抑郁障碍的一种典型情况...</text>
	          </view>
	        </view>
	      </view>
	    </view>
