          ...
          <view class="flex-row section_6 space-x-12" @click="goyuyue">
            ...
            <view class="flex-col flex-auto group_6 space-y-7">
              ...
              <view class="flex-row space-x-18">
                <text class="font_5">北京体育大学</text>
                <text class="font_5 text_16">运动与康复心理学</text>
              </view>
              <text class="self-start font_5">一级康复治疗师，2005年毕...</text>
...
<script>
  ...
  export default {
    ...
    methods: {
		...
		goyuyue(){
			uni.navigateTo({
				url:"/pages/yuyue/yuyue?id=64bf38be09664caf296046d1"
			})
		}
