        ...
        <view class="flex-col list space-y-16">
          <view class="flex-col section_3" :key="i" v-for="(item, i) in list_u2h0dqFG">
            ...
            <view class="flex-col group_4 space-y-4">
              <text class="self-end font_3" v-if="score >= 0 && score <= 4">{{text1}}</text>
              <text class="self-end font_3" v-else-if="score >= 5 && score <= 9">{{text2}}</text>
              <text class="self-end font_3" v-else-if="score >= 10 && score <= 14">{{text3}}</text>
              <text class="self-end font_3" v-else-if="score >= 15">{{text4}}</text>
            </view>
          </view>
        </view>
        ...
        <view class="flex-col section_5">
          ...
          <view class="flex-row section_6 space-x-12" @click="goyuyue">
            <view class="section_7">
				<image src="../../static/teacher1.jpg" mode=""></image>
			</view>
